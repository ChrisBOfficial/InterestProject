...
AnimatedSprite(graphics, "/Users/Christopher/Projects/APCSA Interest Project/APCSA Interest Project/MyChar.png", 0, 0, 16, 16, spawnPoint.x, spawnPoint.y, 100),
_dx(0),
_dy(0),
_facing(RIGHT),
_grounded(false),
...
_currentHealth(3)
{
    graphics.loadImage("/Users/Christopher/Projects/APCSA Interest Project/APCSA Interest Project/MyChar.png");
